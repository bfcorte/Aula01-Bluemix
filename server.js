 ...
 * curl -X POST -H 'Content-type: application/json' http://localhost:4001/dbs/add -d '{"name": "teste"}'
 *   // LIST ALL DOCUMENTS
 *   > curl -X GET http://localhost:4001/doc/list?name=<DATABASE_NAME>
 * curl -X GET http://localhost:4001/doc/list?name=teste
 *   // ADD DOCUMENT
 *   > curl -X POST -H 'Content-type: application/json' http://localhost:4001/doc/add -d '{"name": "<DATABASE_NAME>", "document": {"property": "value"}}'
 *     curl -X POST -H 'Content-type: application/json' http://localhost:4001/doc/add -d '{"name": "teste", "document": {"temperatura": "15"}}'
 *   // GET DOCUMENT
 *   > curl -X GET "http://localhost:4001/doc?name=<DATABASE_NAME>&doc=<DOCUMENT_ID>"
 *     curl -X GET "http://localhost:4001/doc?name=teste&doc=3a96bfc4b4c4151c0361f0f7e99682d8"
 *   // UPDATE DOCUMENT
 ...
 *   curl -X PUT -H 'Content-type: application/json' http://localhost:4001/doc/update -d '{"name": "teste", "document": {"_id": "3a96bfc4b4c4151c0361f0f7e99682d8", "_rev": "1-f0932947036d4fd54fa600a70c21a6b5", "temperatura": "20"}}'
 *   // DELETE DOCUMENT
...
var cloudantCfg = appEnv.getService("sample-db").credentials;
